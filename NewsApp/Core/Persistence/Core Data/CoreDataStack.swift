...
extension CoreDataStack: PersistenceLayerProtocol {
    ...
    func fetchArticle(with identifier: String) -> Article {
    ...
    func persistArticle(_ article: Article) {
        ...
        if let coreDataArticle = NSEntityDescription.insertNewObject(forEntityName: "CoreDataArticle",
                                                                     into: context) as? CoreDataArticle {
